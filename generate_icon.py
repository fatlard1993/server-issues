#!/usr/bin/env python3
"""Generate Server Issues's mod menu icon: the vanilla book and quill.
...
OUT = os.path.join(HERE, "src/main/resources/assets/server-issues/icon.png")
...
def build_icon():
    """A book and quill: writing something down for somebody to read later, which is the whole mod."""
    return scale(vanilla("item/writable_book.png"), 8)
